...
public class Inbox_Adapter extends RecyclerView.Adapter<Inbox_Adapter.CustomViewHolder >{
    public Context context;
    public ArrayList<Inbox_Get_Set> inbox_dataList = new ArrayList<>();
    ...
    public void removeItem(int position) {
        inbox_dataList.remove(position);
        notifyItemRemoved(position);
    }

    public ArrayList<Inbox_Get_Set> getData() {
        return inbox_dataList;
    }
    ...
    public void onBindViewHolder(final Inbox_Adapter.CustomViewHolder holder, final int i) {
        ...
        final Inbox_Get_Set item=inbox_dataList.get(i);
    ...
    public String ChangeDate(String date){
        ...
        long expiredTime=currenttime-databasedate;

        long year = 60000L * 60 * 24 * 365;
        long month = 60000L * 60 * 24 * 30;
        long day = 60000L * 60 * 24;
        long hour = 60000L * 60;
        long minute = 60000L;

        if (expiredTime < minute) {
            return expiredTime < 0 ? "今" : expiredTime/1000 + "秒前";
